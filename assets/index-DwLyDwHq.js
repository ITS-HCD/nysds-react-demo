...
`;var qh=Object.defineProperty,jh=Object.getOwnPropertyDescriptor,s1=(r,l,i,s)=>{for(var c=s>1?void 0:s?jh(l,i):l,d=r.length-1,h;d>=0;d--)(h=r[d])&&(c=(s?h(l,i,c):h(c))||c);return s&&c&&qh(l,i,c),c},wa;const Ea=(wa=class extends He{constructor(){super(...arguments),this.id="",this.name="",this._size="md",this._intent="neutral",this.prefixLabel="",this.label="",this._prefixIcon="",this._suffixIcon=""}get size(){return this._size}set size(r){this._size=wa.VALID_SIZES.includes(r)?r:"md"}get intent(){return this._intent}set intent(r){this._intent=wa.VALID_INTENT.includes(r)?r:"neutral"}get prefixIcon(){return this._prefixIcon}set prefixIcon(r){r===""||r===null?this._prefixIcon=!0:r==="false"||r===!1?this._prefixIcon="":this._prefixIcon=r}get suffixIcon(){return this._suffixIcon}set suffixIcon(r){r===""||r===null?this._suffixIcon=!0:r==="false"||r===!1?this._suffixIcon="":this._suffixIcon=r}connectedCallback(){super.connectedCallback();const r=this.getAttribute("prefixicon");r!==null&&this.prefixIcon===""&&(this.prefixIcon=r);const l=this.getAttribute("suffixicon");l!==null&&this.suffixIcon===""&&(this.suffixIcon=l)}resolveIcon(r){return r===!0?wa.DEFAULT_ICONS[this.intent]??"info":typeof r=="string"&&r.trim()!==""?r:null}render(){const r=this.resolveIcon(this.prefixIcon),l=this.resolveIcon(this.suffixIcon);return G`
    ...
    `}},wa.VALID_SIZES=["sm","md"],wa.VALID_INTENT=["neutral","error","success","warning"],wa.styles=Bh,wa.DEFAULT_ICONS={neutral:"info",error:"emergency_home",success:"check_circle",warning:"warning"},wa);s1([_({type:String})],Ea.prototype,"id",2);s1([_({type:String,reflect:!0})],Ea.prototype,"name",2);s1([_({reflect:!0})],Ea.prototype,"size",1);s1([_({reflect:!0})],Ea.prototype,"intent",1);s1([_({type:String})],Ea.prototype,"prefixLabel",2);s1([_({type:String})],Ea.prototype,"label",2);s1([_({type:String,attribute:"prefixicon"})],Ea.prototype,"prefixIcon",1);s1([_({type:String,attribute:"suffixicon"})],Ea.prototype,"suffixIcon",1);let Zh=Ea;customElements.get("nys-badge")||customElements.define("nys-badge",Zh);const Y3=Pe`
  :host {
    /* Anything that can be overridden should be defined here */
...
`,Xf=`<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
  ...
  <path d="M69.4282 52.8659C69.4135 52.8748 69.3891 52.8858 69.3471 52.8858C69.3178 52.8858 69.2837 52.8798 69.27 52.8659L68.9889 52.1476C68.9723 52.1088 68.9459 52.0323 68.944 52.0214C68.944 52.0264 68.9371 52.1277 68.9332 52.1565L68.8815 52.9205C68.8815 52.9205 68.8561 52.9404 68.7858 52.9404C68.7155 52.9404 68.6862 52.9205 68.6862 52.9205L68.7839 51.6787C68.7839 51.6787 68.8112 51.6588 68.8776 51.6588C68.9518 51.6588 68.9781 51.6787 68.9781 51.6787L69.3042 52.5162L69.3471 52.6533C69.3481 52.6473 69.3774 52.5559 69.392 52.5162L69.7181 51.6787C69.7181 51.6787 69.7464 51.6588 69.8206 51.6588C69.886 51.6588 69.9124 51.6787 69.9124 51.6787L70.01 52.9205C70.01 52.9205 69.9807 52.9404 69.9104 52.9404C69.8401 52.9404 69.8167 52.9205 69.8167 52.9205L69.763 52.1546L69.7523 52.0194C69.7523 52.0194 69.722 52.1148 69.7093 52.1456L69.4282 52.8659Z" fill="#154973"/>
    ...
    `}};dd.styles=Gf;let Ma=dd;G1([_({type:Boolean})],Ma.prototype,"trustbarVisible");G1([_({type:Boolean})],Ma.prototype,"searchDropdownVisible");G1([_({type:Boolean})],Ma.prototype,"languageVisible");G1([_({type:Boolean})],Ma.prototype,"isSearchFocused");G1([_({type:Boolean})],Ma.prototype,"hideTranslate");G1([_({type:Boolean})],Ma.prototype,"hideSearch");G1([_({type:String,reflect:!0})],Ma.prototype,"languages");customElements.get("nys-unavheader")||customElements.define("nys-unavheader",Ma);const Ff=Pe`
  :host {
...
`;var Kf=Object.defineProperty,pi=(r,l,i,s)=>{for(var c=void 0,d=r.length-1,h;d>=0;d--)(h=r[d])&&(c=h(l,i,c)||c);return c&&Kf(l,i,c),c};const hd=class extends He{constructor(){super(...arguments),this.appName="",this.agencyName="",this.homepageLink="",this.slotHasContent=!0,this.isMobileMenuOpen=!1}firstUpdated(){var l;const i=(l=this.shadowRoot)==null?void 0:l.querySelector("slot");i==null||i.addEventListener("slotchange",()=>this._handleSlotChange()),this._handleSlotChange(),this._listenLinkClicks(),window.addEventListener("popstate",()=>this._handleSlotChange()),window.addEventListener("hashchange",()=>this._handleSlotChange())}async _handleSlotChange(){var l,i,s;console.log("YOU ARE IN THE SLOT CHANGE");const c=(l=this.shadowRoot)==null?void 0:l.querySelector("slot");if(!c)return;const d=c==null?void 0:c.assignedNodes({flatten:!0}).filter(y=>y.nodeType===Node.ELEMENT_NODE);await Promise.resolve(),this.slotHasContent=d.length>0;const h=(i=this.shadowRoot)==null?void 0:i.querySelector(".nys-globalheader__content"),g=(s=this.shadowRoot)==null?void 0:s.querySelector(".nys-globalheader__content-mobile");if(h&&g){h.innerHTML="",g.innerHTML="";const y=this._normalizePath(window.location.pathname+window.location.hash);d.forEach(p=>{if(p.nodeType===Node.ELEMENT_NODE){const b=p.cloneNode(!0),w=p.cloneNode(!0);["script","iframe","object","embed, img"].forEach(E=>{b.querySelectorAll(E).forEach(L=>L.remove())}),b.querySelectorAll("a").forEach(E=>{const L=E.getAttribute("href"),N=this._normalizePath(L);if(N){if(console.log("this is the linkPath ",N),console.log("this is the currentUrl ",y),N==="/"){if(y==="/"){console.log("HUH");const X=E.closest("li");X&&X.classList.add("active")}}else if(N===y){console.log("YES");const X=E.closest("li");X&&X.classList.add("active")}}}),w.querySelectorAll("a").forEach(E=>{const L=E.getAttribute("href"),N=this._normalizePath(L);if(N){if(N==="/"){if(y==="/"){const X=E.closest("li");X&&X.classList.add("active")}}else if(N===y){const X=E.closest("li");X&&X.classList.add("active")}}}),h.appendChild(b),g.appendChild(w),p.remove()}})}}_normalizePath(l){if(l)return l.startsWith("/")||(l="/"+l),l.length>1&&l.endsWith("/")&&(l=l.slice(0,-1)),l.toLowerCase()}_toggleMobileMenu(){this.isMobileMenuOpen=!this.isMobileMenuOpen}_listenLinkClicks(){var l;const i=(l=this.shadowRoot)==null?void 0:l.querySelectorAll(".nys-globalheader__content, .nys-globalheader__content-mobile");i==null||i.forEach(s=>{s==null||s.addEventListener("click",c=>{const d=c.target.closest("a");if(!d)return;s.querySelectorAll("li.active").forEach(g=>g.classList.remove("active"));const h=d.closest("li");h&&h.classList.add("active")})})}render(){var l,i,s,c,d,h,g,y;return G`
