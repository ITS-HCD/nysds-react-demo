 ...
 */var y0;function N4(){if(y0)return F1;y0=1;var l=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function o(s,c,d){var h=null;if(d!==void 0&&(h=""+d),c.key!==void 0&&(h=""+c.key),"key"in c){d={};for(var v in c)v!=="key"&&(d[v]=c[v])}else d=c;return c=d.ref,{$$typeof:l,type:s,key:h,ref:c!==void 0?c:null,props:d}}return F1.Fragment=r,F1.jsx=o,F1.jsxs=o,F1}var p0;function U4(){return p0||(p0=1,l5.exports=N4()),l5.exports}var T=U4(),o5={exports:{}},we={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`+JSON.stringify(b,null,2)),r(b)},c=p=>{const b={},w=new FormData(p);for(const[E,A]of w.entries()){const U=w.getAll(E);U.length>1?b[E]=U.map(X=>X instanceof File?{fileName:X.name,fileType:X.type}:X):b[E]=A instanceof File?{name:A.name,type:A.type,size:A.size}:A}return b},d=()=>{o.current&&(o.current.open=!0)},h=()=>{o.current&&(o.current.open=!1)},v=()=>{alert(`*Slaps face* >:[ 
 ...
 (The Office: Season 5, Episode 19) `),h()},y=()=>{console.log("hi there"),alert("HELLO")};return T.jsxs("div",{className:"main-content",children:[T.jsx("h1",{className:"appTitle",children:"Vite + React + NYSDS"}),T.jsx(ld,{type:"info",heading:"Using NYSDS Components in Forms",text:"The form below shows how NYSDS form components can be used inside a standard HTML form. Each of our web components work with normal form submission and validation, allowing you to collect and process data through formData just like native controls.",primaryLabel:"Learn more about NYSDS on our reference site",primaryAction:"https://designsystem.ny.gov/",dismissible:!0}),T.jsx(na,{id:"my-button",label:"Hover Me"}),T.jsx(na,{type:"button",label:"ALERT",onNysClick:y}),T.jsx(py,{id:"my-icon",name:"info",size:"3xl"}),T.jsxs("form",{id:"myForm",className:"nys-newsletter-form",method:"POST",onSubmit:s,children:[T.jsx(or,{id:"my-textinput",name:"fullName",label:"Full name",description:"Enter your full legal name",required:!0,onNysBlur:p=>{console.log("nys-blur event received 🔥",p)}}),T.jsx(or,{name:"email",label:"Email",type:"email",required:!0}),T.jsx(k3,{name:"quote",label:"Enter your favorite quote:",value:"Majorities, of course, start with minorities.",required:!0}),T.jsxs(my,{name:"newsletter_topic",label:"Select your preferred newsletter topic",id:"newsletter-topic",required:!0,children:[T.jsx("option",{value:"government_updates",label:"Government Updates"}),T.jsx("option",{value:"community_events",label:"Community Events"}),T.jsx("option",{value:"public_services",label:"Public Services & Resources"}),T.jsx("option",{value:"transportation_news",label:"Transportation & Infrastructure"}),T.jsx("option",{value:"environment",label:"Environment & Sustainability"})]}),T.jsx(yy,{name:"uploadImg",label:"Upload a file",description:"Accepted file types: .jpg, .png, .pdf",accept:"image/png, image/jpeg, .pdf",multiple:!0,dropzone:!0,required:!0}),T.jsxs(gy,{label:"How often do you want updates?",description:"These updates will be sent directly to your email.",size:"md",required:!0,children:[T.jsx(od,{name:"frequency",label:"Weekly",value:"weekly"}),T.jsx(od,{name:"frequency",label:"Monthly",value:"monthly"})]}),T.jsx(ql,{label:"Subscribe to NYS Government Updates",description:"Get notified via email about important updates and services.",id:"subscribe-checkbox-disabled-checked",name:"subscribe",value:"email-updates",required:!0}),T.jsxs(fy,{label:"Select your favorite New York landmarks",description:"Choose from the options below",required:!0,children:[T.jsx(ql,{name:"landmarks",label:"Adirondacks",value:"adirondacks"}),T.jsx(ql,{name:"landmarks",value:"finger-lakes",label:"Finger Lakes"}),T.jsx(ql,{name:"landmarks",value:"catskills",label:"Catskills"}),T.jsx(ql,{name:"landmarks",value:"niagara-falls",label:"Niagara Falls"}),T.jsx(ql,{name:"landmarks",value:"coney-island",label:"Coney Island"})]}),T.jsx(_y,{label:"Dark Mode",name:"toggle-switch",value:"dark_mode_on",children:T.jsx("p",{slot:"description",children:"Toggle switch is usually NOT recommended for forms (use checkboxes instead)."})}),T.jsx(na,{type:"submit",fullWidth:!0,label:"Subscribe"})]}),T.jsx("br",{}),l&&T.jsx(ld,{type:"success",heading:"Form submitted successfully",text:`${l?`

Submitted Data:
`+JSON.stringify(l,null,2):""}`,dismissible:!0}),T.jsx(na,{label:"Knock Knock (Show Modal)",onNysClick:d,variant:"outline"}),T.jsxs(vy,{ref:o,id:"myModal",heading:"Who's there?",subheading:"KGB...",children:[T.jsx("p",{children:"Ipsum Lorem. Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit..."}),T.jsxs("div",{slot:"actions",children:[T.jsx(na,{label:"Don't answer",variant:"outline",onNysClick:h}),T.jsx(na,{label:"KGB who?",onNysClick:v})]})]}),T.jsx(C5,{text:"I AM ICON TOOLTIP",for:"my-icon",focusable:!0,position:"left"}),T.jsx(C5,{for:"my-button",text:"I am a tooltip.",position:"top"}),T.jsx(C5,{for:"my-textinput",text:"I am a textinput tooltip."})]})},M3=()=>T.jsxs("div",{className:"main-content stepper-content nys-display-flex nys-flex-column nys-flex-justify",children:[T.jsx("h1",{children:"Personal Details (Sample 1)"}),T.jsx("p",{children:"This is the form to enter your personal information. Fill in your name, address, and contact details here."}),T.jsx(or,{name:"fullName",label:"Full Name",required:!0}),T.jsx(or,{name:"email",label:"Email Address",type:"email",required:!0}),T.jsx(or,{name:"phone",label:"Phone Number",type:"tel"}),T.jsx(or,{name:"address",label:"Street Address"})]}),D3=()=>T.jsxs("div",{className:"main-content stepper-content nys-display-flex nys-flex-column nys-flex-justify",children:[T.jsx("h1",{children:"Team Information (Sample 2)"}),T.jsx("p",{children:"Provide details about your team. Who are you working with? What is your role?"}),T.jsx(or,{name:"teamMembers",label:"Who are you working with?",required:!0}),T.jsx(or,{name:"role",label:"What is your role?",required:!0}),T.jsxs(hy,{singleSelect:!0,bordered:!0,children:[T.jsx(rd,{heading:"Eligibility Requirements",children:T.jsx("p",{children:"You must be a New York State resident and provide valid proof of identification. Additional documentation may be required depending on the type of service you are applying for."})}),T.jsx(rd,{heading:"Required Documents",children:T.jsxs("ul",{children:[T.jsx("li",{children:"Proof of Identity (Driver License, State ID, or Passport)"}),T.jsx("li",{children:"Proof of Residency (Utility Bill, Lease Agreement)"}),T.jsx("li",{children:"Completed Application Form"})]})})]})]}),A3=()=>T.jsxs("div",{className:"main-content stepper-content nys-display-flex nys-flex-column nys-flex-justify",children:[T.jsx("h1",{children:"Usage Survey (Sample 3)"}),T.jsx(k3,{name:"quote",label:"Tell us how you plan to use this application?",description:"Your feedback helps us improve.",required:!0})]}),ky=()=>{const[l,r]=$.useState(1),[o,s]=$.useState(1),c=()=>r(y=>Math.max(y-1,1)),d=()=>{h()?r(y=>{const p=Math.min(y+1,3);return s(b=>Math.max(b,p)),p}):console.warn("Current step invalid. Cannot proceed.")},h=()=>{const y=document.querySelector(".stepper-form");if(!y)return!1;const p=y.querySelector(`.step-page:nth-child(${l})`),b=Array.from(Array.from(p.querySelectorAll("*")).filter(E=>typeof E.checkValidity=="function"));let w=!0;return b.forEach(E=>{E.checkValidity&&(E.checkValidity()||(w=!1,E.dispatchEvent(new Event("invalid",{bubbles:!0}))))}),w},v=y=>{y.preventDefault();const p=new FormData(y.target),b={};for(const[w,E]of p.entries()){const A=p.getAll(w);A.length>1?b[w]=A.map(U=>U instanceof File?{fileName:U.name,fileType:U.type}:U):b[w]=E instanceof File?{name:E.name,type:E.type,size:E.size}:E}alert(`Form Data:
`+JSON.stringify(b,null,2))};return T.jsxs("div",{className:"nys-flex-1 nys-grid-row",children:[T.jsxs(by,{className:"nys-desktop:nys-grid-col-3",label:"Register for Design System Office Hours",children:[T.jsx(_5,{label:"Sample 1",onClick:()=>r(1),selected:l===1,current:o===1}),T.jsx(_5,{label:"Sample 2",onClick:()=>r(2),selected:l===2,current:o===2}),T.jsx(_5,{label:"Sample 3",onClick:()=>r(3),selected:l===3,current:o===3}),T.jsx("div",{slot:"actions",children:T.jsx(na,{variant:"outline",label:"Save & Exit",fullWidth:!0})})]}),T.jsxs("form",{action:"",className:"stepper-form",onSubmit:v,children:[T.jsx("div",{className:`step-page ${l===1?"":"hidden"}`,children:T.jsx(M3,{})}),T.jsx("div",{className:`step-page ${l===2?"":"hidden"}`,children:T.jsx(D3,{})}),T.jsx("div",{className:`step-page ${l===3?"":"hidden"}`,children:T.jsx(A3,{})}),T.jsxs("div",{className:"stepper-content button-container nys-display-flex",children:[l>1&&T.jsx(na,{type:"button",label:"Back",onClick:c}),l<3?T.jsx(na,{type:"button",label:"Next",onClick:d}):T.jsx(na,{type:"submit",label:"Submit",variant:"outline"})]})]})]})},Sy=()=>T.jsxs(T.Fragment,{children:[T.jsx(w3,{}),T.jsx(E3,{}),T.jsx(x3,{appName:"React Demo Form",agencyName:"Office of Information Technology Services",homepageLink:"/",children:T.jsxs("ul",{children:[T.jsx("li",{children:T.jsx("a",{href:"/nysds-react-demo",children:"Home"})}),T.jsx("li",{children:T.jsx("a",{href:"/nysds-react-demo/#/basic-form",children:"Basic Form"})}),T.jsx("li",{children:T.jsx("a",{href:"/nysds-react-demo/#/stepper",children:"Stepper"})}),T.jsx("li",{children:T.jsx("a",{href:"/nysds-react-demo/#/about",children:"About"})})]})}),T.jsxs("div",{className:"main-content nys-flex-1 nys-display-flex nys-flex-column nys-flex-align-center",children:[T.jsx("h1",{children:"Oh no, this route doesn't exist!"}),T.jsx("img",{src:"error-image.png",alt:"",role:"presentation"}),T.jsx(Fi,{to:"/",className:"centered-link",children:"You can go back to the home page by clicking here, though!"})]}),T.jsx(C3,{agencyName:"Office of Information Technology Services",children:T.jsxs("ul",{children:[T.jsx("li",{children:T.jsx("a",{href:"https://its.ny.gov",children:"ITS Home"})}),T.jsx("li",{children:T.jsx("a",{href:"https://its.ny.gov/about",children:"About ITS"})})]})}),T.jsx(S3,{}),T.jsx(_3,{})]}),Ey=Zh([{path:"/",element:T.jsx(Cy,{}),children:[{index:!0,element:T.jsx(xy,{})},{path:"basic-form",element:T.jsx(wy,{})},{path:"stepper",element:T.jsx(ky,{}),children:[{index:!0,element:T.jsx(mh,{to:"sample1",replace:!0})},{path:"sample1",element:T.jsx(M3,{})},{path:"sample2",element:T.jsx(D3,{})},{path:"sample3",element:T.jsx(A3,{})}]}],errorElement:T.jsx(Sy,{})}]),My=()=>T.jsx(n9,{router:Ey});X4.createRoot(document.getElementById("root")).render(T.jsx($.StrictMode,{children:T.jsx(My,{})}));
