 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var L3;function n4(){return L3||(L3=1,function(c){function s(H,Q){var j=H.length;H.push(Q);e:for(;0<j;){var ye=j-1>>>1,g=H[ye];if(0<d(g,Q))H[ye]=Q,H[j]=g,j=ye;else break e}}function o(H){return H.length===0?null:H[0]}function r(H){if(H.length===0)return null;var Q=H[0],j=H.pop();if(j!==Q){H[0]=j;e:for(var ye=0,g=H.length,A=g>>>1;ye<A;){var Z=2*(ye+1)-1,R=H[Z],U=Z+1,te=H[U];if(0>d(R,j))U<g&&0>d(te,R)?(H[ye]=te,H[U]=j,ye=U):(H[ye]=R,H[Z]=j,ye=Z);else if(U<g&&0>d(te,j))H[ye]=te,H[U]=j,ye=U;else break e}}return Q}function d(H,Q){var j=H.sortIndex-Q.sortIndex;return j!==0?j:H.id-Q.id}if(c.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var y=performance;c.unstable_now=function(){return y.now()}}else{var v=Date,D=v.now();c.unstable_now=function(){return v.now()-D}}var k=[],x=[],T=1,O=null,J=3,G=!1,ne=!1,at=!1,ut=typeof setTimeout=="function"?setTimeout:null,s1=typeof clearTimeout=="function"?clearTimeout:null,We=typeof setImmediate<"u"?setImmediate:null;function Nt(H){for(var Q=o(x);Q!==null;){if(Q.callback===null)r(x);else if(Q.startTime<=H)r(x),Q.sortIndex=Q.expirationTime,s(k,Q);else break;Q=o(x)}}function M1(H){if(at=!1,Nt(H),!ne)if(o(k)!==null)ne=!0,r1();else{var Q=o(x);Q!==null&&nt(M1,Q.startTime-H)}}var oe=!1,lt=-1,D1=5,A1=-1;function B(){return!(c.unstable_now()-A1<D1)}function re(){if(oe){var H=c.unstable_now();A1=H;var Q=!0;try{e:{ne=!1,at&&(at=!1,s1(lt),lt=-1),G=!0;var j=J;try{t:{for(Nt(H),O=o(k);O!==null&&!(O.expirationTime>H&&B());){var ye=O.callback;if(typeof ye=="function"){O.callback=null,J=O.priorityLevel;var g=ye(O.expirationTime<=H);if(H=c.unstable_now(),typeof g=="function"){O.callback=g,Nt(H),Q=!0;break t}O===o(k)&&r(k),Nt(H)}else r(k);O=o(k)}if(O!==null)Q=!0;else{var A=o(x);A!==null&&nt(M1,A.startTime-H),Q=!1}}break e}finally{O=null,J=j,G=!1}Q=void 0}}finally{Q?xt():oe=!1}}}var xt;if(typeof We=="function")xt=function(){We(re)};else if(typeof MessageChannel<"u"){var o1=new MessageChannel,Qt=o1.port2;o1.port1.onmessage=re,xt=function(){Qt.postMessage(null)}}else xt=function(){ut(re,0)};function r1(){oe||(oe=!0,xt())}function nt(H,Q){lt=ut(function(){H(c.unstable_now())},Q)}c.unstable_IdlePriority=5,c.unstable_ImmediatePriority=1,c.unstable_LowPriority=4,c.unstable_NormalPriority=3,c.unstable_Profiling=null,c.unstable_UserBlockingPriority=2,c.unstable_cancelCallback=function(H){H.callback=null},c.unstable_continueExecution=function(){ne||G||(ne=!0,r1())},c.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D1=0<H?Math.floor(1e3/H):5},c.unstable_getCurrentPriorityLevel=function(){return J},c.unstable_getFirstCallbackNode=function(){return o(k)},c.unstable_next=function(H){switch(J){case 1:case 2:case 3:var Q=3;break;default:Q=J}var j=J;J=Q;try{return H()}finally{J=j}},c.unstable_pauseExecution=function(){},c.unstable_requestPaint=function(){},c.unstable_runWithPriority=function(H,Q){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var j=J;J=H;try{return Q()}finally{J=j}},c.unstable_scheduleCallback=function(H,Q,j){var ye=c.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?ye+j:ye):j=ye,H){case 1:var g=-1;break;case 2:g=250;break;case 5:g=1073741823;break;case 4:g=1e4;break;default:g=5e3}return g=j+g,H={id:T++,callback:Q,priorityLevel:H,startTime:j,expirationTime:g,sortIndex:-1},j>ye?(H.sortIndex=j,s(x,H),o(k)===null&&H===o(x)&&(at?(s1(lt),lt=-1):at=!0,nt(M1,j-ye))):(H.sortIndex=g,s(k,H),ne||G||(ne=!0,r1())),H},c.unstable_shouldYield=B,c.unstable_wrapCallback=function(H){var Q=J;return function(){var j=J;J=Q;try{return H.apply(this,arguments)}finally{J=j}}}}(E5)),E5}var H3;function i4(){return H3||(H3=1,S5.exports=n4()),S5.exports}var z5={exports:{}},Fe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var T3;function s4(){if(T3)return Fe;T3=1;var c=U5();function s(k){var x="https://react.dev/errors/"+k;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var T=2;T<arguments.length;T++)x+="&args[]="+encodeURIComponent(arguments[T])}return"Minified React error #"+k+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function o(){}var r={d:{f:o,r:function(){throw Error(s(522))},D:o,C:o,L:o,m:o,X:o,S:o,M:o},p:0,findDOMNode:null},d=Symbol.for("react.portal");function y(k,x,T){var O=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:O==null?null:""+O,children:k,containerInfo:x,implementation:T}}var v=c.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function D(k,x){if(k==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return Fe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,Fe.createPortal=function(k,x){var T=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(s(299));return y(k,x,null,T)},Fe.flushSync=function(k){var x=v.T,T=r.p;try{if(v.T=null,r.p=2,k)return k()}finally{v.T=x,r.p=T,r.d.f()}},Fe.preconnect=function(k,x){typeof k=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,r.d.C(k,x))},Fe.prefetchDNS=function(k){typeof k=="string"&&r.d.D(k)},Fe.preinit=function(k,x){if(typeof k=="string"&&x&&typeof x.as=="string"){var T=x.as,O=D(T,x.crossOrigin),J=typeof x.integrity=="string"?x.integrity:void 0,G=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;T==="style"?r.d.S(k,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:O,integrity:J,fetchPriority:G}):T==="script"&&r.d.X(k,{crossOrigin:O,integrity:J,fetchPriority:G,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},Fe.preinitModule=function(k,x){if(typeof k=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var T=D(x.as,x.crossOrigin);r.d.M(k,{crossOrigin:T,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&r.d.M(k)},Fe.preload=function(k,x){if(typeof k=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var T=x.as,O=D(T,x.crossOrigin);r.d.L(k,T,{crossOrigin:O,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},Fe.preloadModule=function(k,x){if(typeof k=="string")if(x){var T=D(x.as,x.crossOrigin);r.d.m(k,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:T,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else r.d.m(k)},Fe.requestFormReset=function(k){r.d.r(k)},Fe.unstable_batchedUpdates=function(k,x){return k(x)},Fe.useFormState=function(k,x,T){return v.H.useFormState(k,x,T)},Fe.useFormStatus=function(){return v.H.useHostTransitionStatus()},Fe.version="19.0.0",Fe}var O3;function o4(){if(O3)return z5.exports;O3=1;function c(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(c)}catch(s){console.error(s)}}return c(),z5.exports=s4(),z5.exports}/**
 * @license React
 ...
 */const d4=new Set(["children","localName","ref","style","className"]),V3=new WeakMap,N3=(c,s,o,r,d)=>{const y=d==null?void 0:d[s];y===void 0?(c[s]=o,o==null&&s in HTMLElement.prototype&&c.removeAttribute(s)):o!==r&&((v,D,k)=>{let x=V3.get(v);x===void 0&&V3.set(v,x=new Map);let T=x.get(D);k!==void 0?T===void 0?(x.set(D,T={handleEvent:k}),v.addEventListener(D,T)):T.handleEvent=k:T!==void 0&&(x.delete(D),v.removeEventListener(D,T))})(c,y,o)},Ne=({react:c,tagName:s,elementClass:o,events:r,displayName:d})=>{const y=new Set(Object.keys(r??{})),v=c.forwardRef((D,k)=>{const x=c.useRef(new Map),T=c.useRef(null),O={},J={};for(const[G,ne]of Object.entries(D))d4.has(G)?O[G==="className"?"class":G]=ne:y.has(G)||G in o.prototype?J[G]=ne:O[G]=ne;return c.useLayoutEffect(()=>{if(T.current===null)return;const G=new Map;for(const ne in J)N3(T.current,ne,D[ne],x.current.get(ne),r),x.current.delete(ne),G.set(ne,D[ne]);for(const[ne,at]of x.current)N3(T.current,ne,void 0,at,r);x.current=G}),c.useLayoutEffect(()=>{var G;(G=T.current)==null||G.removeAttribute("defer-hydration")},[]),O.suppressHydrationWarning=!0,c.createElement(s,{...O,ref:c.useCallback(G=>{T.current=G,typeof k=="function"?k(G):k!==null&&(k.current=G)},[k])})});return v.displayName=d??o.name,v};/**
 * @license
...
`;var Q6=Object.defineProperty,qn=(c,s,o,r)=>{for(var d=void 0,y=c.length-1,v;y>=0;y--)(v=c[y])&&(d=v(s,o,d)||d);return d&&Q6(s,o,d),d};const E0=class extends he{constructor(){super(...arguments),this.appName="",this.agencyName="",this.homepageLink="",this.slotHasContent=!0,this.isMobileMenuOpen=!1}firstUpdated(){var s;const o=(s=this.shadowRoot)==null?void 0:s.querySelector("slot");o==null||o.addEventListener("slotchange",()=>this._handleSlotChange()),this._handleSlotChange()}async _handleSlotChange(){var s,o,r;const d=(s=this.shadowRoot)==null?void 0:s.querySelector("slot");if(!d)return;const y=d==null?void 0:d.assignedNodes({flatten:!0}).filter(k=>k.nodeType===Node.ELEMENT_NODE);await Promise.resolve(),this.slotHasContent=y.length>0;const v=(o=this.shadowRoot)==null?void 0:o.querySelector(".nys-globalheader__content"),D=(r=this.shadowRoot)==null?void 0:r.querySelector(".nys-globalheader__content-mobile");v&&D&&(v.innerHTML="",D.innerHTML="",y.forEach(k=>{if(k.nodeType===Node.ELEMENT_NODE){const x=k.cloneNode(!0),T=k.cloneNode(!0);["script","iframe","object","embed, img"].forEach(O=>{x.querySelectorAll(O).forEach(J=>J.remove())}),v.appendChild(x),D.appendChild(T),k.remove()}}))}_toggleMobileMenu(){this.isMobileMenuOpen=!this.isMobileMenuOpen}render(){var s,o,r,d,y,v,D,k;return L`
