...
//         <h1>About the NYSDS React Demo</h1>
//         <p>
//           This project demonstrates how to integrate the NYS Design System
//           (NYSDS) into a modern React + TypeScript application. It showcases
//           real-world patterns for wrapping and using NYSDS web components
...
//             View the GitHub repository and setup instructions
//           </p>
//         </a>
...
//           />
//           <p className="centered-link">
//             Learn more about NYSDS updates and milestones
//           </p>
//         </a>
//       </div>

//       <div className="welcome-section">
//         <h2>How This Demo Was Built</h2>
//         <p>
//           The project was scaffolded using Vite with the React + TypeScript
//           template. After setup, the required dependencies were installed:
//           <br />
//           <strong>@nysds/components</strong>, <strong>@nysds/styles</strong>,
//           and <strong>@lit/react</strong>.
//         </p>
//         <p>
//           Because NYSDS components are built as web components using Lit,
//           they must be wrapped using <strong>@lit/react</strong> to function
//           properly within React. In this demo, wrapper definitions are created
//           in a utility file and then imported into individual pages.
//         </p>
//         <p>
//           This repository includes two branches:
//           <br />
//           <strong>main</strong> – a multi-page demo reflecting a realistic app
//           structure.
//           <br />
//           <strong>intro/single-page</strong> – a simplified example for those
//           getting started.
//         </p>
//       </div>
//     </div>
