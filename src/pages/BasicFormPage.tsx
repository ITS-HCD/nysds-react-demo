...
import {NysRadiobuttonComponent, NysCheckboxComponent, NysCheckboxgroupComponent} from "../utils/nysds-components";

import {
   NysButton, NysCheckbox, NysCheckboxgroup, NysDatepicker, NysFileinput, NysModal, NysRadiobutton, NysRadiogroup, NysSelect, NysTextinput, NysTextarea, NysToggle, NysTooltip
} from "../../react-wrappers/index.js";

import {NysAlert} from "@nysds/components";
...
<div className='main-content'>
         ...
         <form
           ...
           onSubmit={handleSubmit}
         >       
                    <NysDatepicker  id="my-datepicker" name="my-datepicker" type="date" label="Schedule an appointment" description="Enter in MM/DD/YYYY format" />
           ...
           <NysTooltip for="my-textinput" text="I am a tooltip, used for hints."></NysTooltip>
           <NysTextinput id="my-textinput" name='fullName' label="Full name" description='Enter your full legal name' 
             onNysBlur={(e) => {
               console.log('nys-blur event received 🔥', e);
             }}
             />
           <NysTextinput name='email' label="Email" type="email" />
           <NysTextarea id="my-textarea" name='quote' label="Enter your favorite quote:" value="Majorities, of course, start with minorities." />

           {/* Note: when wrapping components within a component, you will need a closing tag (e.g. select, radiogroup, checkboxgroup, slot wrappings for inner HTML elements) */}
           <NysSelect name="newsletter_topic" label="Select your preferred newsletter topic" id="newsletter-topic" >
             {/* <option value="">--Please choose an option--</option> */}
             <option value="government_updates" label="Government Updates" />
             <option value="community_events" label="Community Events" />
             <option value="public_services" label="Public Services & Resources" />
           ...
           <NysFileinput id="my-fileinput" name="uploadImg" label="Upload a file" description="Accepted file types: .jpg, .png, .pdf" accept="image/png, image/jpeg, .pdf" multiple dropzone />
 ...
 <br>        
         ...
         {/* MODAL SHOWCASE */}
         <NysButton type="button" label="Knock Knock (Show Modal)" onNysClick={openModal} variant="outline"></NysButton>
         <NysModal ref={modalRef} id="myModal" heading="Who's there?" subheading='KGB...'>
           <p>Ipsum Lorem. Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...</p>
           <div slot="actions">
             <NysButton
               label="Don't answer"
               ...
               onNysClick={closeModal}
             ></NysButton>
             <NysButton label="KGB who?" onNysClick={saveChanges}></NysButton>
           </div>
         </NysModal>
</div>
  );
